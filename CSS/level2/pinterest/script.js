...
function handleSearh() {
  ...
  input.addEventListener("input", () => {
    var filterdObj = arr.filter((data) => 
      data.name.toLowerCase().startsWith(input.value)
    );
  var data= "";
      filterdObj.forEach((item) => {
        data += `<div class="res flex px-8 py-3">
           <i class="ri-search-line font-semibold mr-5"></i>
      ...
      document.querySelector(".searchdata").style.display = "block";
      document.querySelector(".searchdata").innerHTML = data;
